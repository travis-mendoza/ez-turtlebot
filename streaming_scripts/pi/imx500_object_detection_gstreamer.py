"""
imx500_object_detection_gstreamer.py - Object detection demo for IMX500 AI Camera with GStreamer streaming

This script demonstrates how to use the IMX500 AI Camera for object detection
and stream the output with detection overlays to a remote PC using GStreamer.

Usage:
    python imx500_object_detection_gstreamer.py --model /usr/share/imx500-models/imx500_network_ssd_mobilenetv2_fpnlite_320x320_pp.rpk --ip 192.168.1.100 --port 5000
"""
import argparse
import sys
...
if __name__ == "__main__":
    ...
    # Configure camera with main and video streams
